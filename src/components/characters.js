...
const characters = [
  ...
  { name: "Larry the Lobster", src: LL },
  { name: "Mr. Krabs", src: MK },
  { name: "Mrs. Puff", src: MP },
  { name: "Patrick", src: P },
  { name: "Pearl the Whale", src: PW },
  { name: "Karen", src: K },
  { name: "Sandy", src: S },
  { name: "SpongeBob SquarePants", src: SS },
  { name: "Squidward", src: SW },
  { name: "Gary", src: G },
  { name: "Plankton", src: PL },
  { name: "Krusty Krab Hat", src: KK },
  { name: "Beatrice", src: B },
